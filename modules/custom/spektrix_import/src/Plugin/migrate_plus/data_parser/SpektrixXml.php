...
namespace Drupal\spektrix_import\Plugin\migrate_plus\data_parser;
 ...
 * @DataParser(
 *   id = "spektrix_xml",
 *   title = @Translation("Spektrix XML")
 * )
 */
class SpektrixXml extends DataParserPluginBase {
